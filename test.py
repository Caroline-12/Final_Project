...
# Function to scrape reviews from the web using SerpAPI
...
# Sidebar inputs
keyword = st.sidebar.text_input("Keyword for Business (e.g., Restaurant, IT Services)", " ")
location = st.sidebar.text_input("Location (e.g., Nairobi, Mombasa)", " ")
